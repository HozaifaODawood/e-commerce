    ...
    return (
        <>
            ...
            <form onSubmit={formik.handleSubmit}>
                ...
                <button
                    type="button"
                    onClick={() => setShowForget(true)} className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 ms-5">
                    Forget Password ?
                </button>
            </form >
            ...
            {showForget && (
                <>
                    <div onClick={() => setShowForget(false)} className="fixed inset-0 bg-black/40 flex justify-center items-center">
                    </div>
                    ...
                    <form onSubmit={forgotPasswordFormik.handleSubmit} >
                        ...
                        {
                            forgetPErrorMsg ? <div className="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                                {forgetPErrorMsg}
                            </div> : null
                        }
                        ...
                        <button type="submit" className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-3 mb-6 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                            Submit
                        </button>

                        <button onClick={() => setShowForget(false)} type="submit" className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-3 mb-6 ms-3 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                            Cancel
                        </button>
